        ...
        <>
          ...
          <div className="sm:hidden space-y-3">
            {employees.map((emp) => {
              ...
              return (
                <div key={emp.id} className="bg-white border rounded-xl p-4 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="font-semibold text-gray-900 text-base truncate">{emp.name}</p>
                      <Badge variant="outline" className="mt-0.5 text-xs">{typeName}</Badge>
                    </div>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <span className={`font-mono font-medium ${colors.text}`}>{emp.scheduled_hours}h scheduled</span>
                    <span className="text-gray-300">·</span>
                    <span className="font-mono text-gray-500">{emp.remaining_hours}h remaining</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Progress value={Math.min(emp.usage_percent, 100)} className="h-2 flex-1" />
                    <span className="text-xs text-gray-500 w-8 text-right">{emp.usage_percent}%</span>
                  </div>
                  <div className="flex gap-2 pt-1">
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="flex-1 h-11 text-red-600 border-red-200 hover:bg-red-50 hover:text-red-700"
